...
<div class="floatLeft">Membership Freeze</div>
...
<form method="post" action="{{ URL::to('membership/freeze/submit') }}">
...
<table class="tableStyling" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td align="center">Would you like to freeze this membership?</td>
	</tr>
	<tr>
		<td align="right">Date: <input type="text" id="freezed_at" name="freezed_at" value="{{ date('d-M-Y') }}"</td>
	</tr>
	<tr>
